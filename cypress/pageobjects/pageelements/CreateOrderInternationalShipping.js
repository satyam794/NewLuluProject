...
export default class CreateOrderInternationalShipping
{
    ...
    ClickOverrideCheckbox()
    {
        return cy.getIframe().find(loc.shippingaddress.selectoverridecheckbox)
    }
    ...
    enterState()
    {
        return cy.getIframe().find(loc.shippingaddress.enterintstate)
    }
