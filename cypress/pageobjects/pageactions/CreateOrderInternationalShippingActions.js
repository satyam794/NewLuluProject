...
import CreateOrderInternationalShipping from "../../pageobjects/pageelements/CreateOrderInternationalShipping"

export default class CreateOrderInternationalShippingActions
{
    constructor(){

        globalThis.order = new CreateOrderInternationalShipping();
    }
    ...
    AddShippingAddress(addresstype, fname, lname, phone, emailid, address1, address2, city, zipcode, country, state)
    {
            ...
            else
            {
                ...
                order.ClickOverrideCheckbox().check({force : true})
