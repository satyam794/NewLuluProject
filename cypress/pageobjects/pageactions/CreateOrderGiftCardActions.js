...
import CreateOrderGiftCard from "../../pageobjects/pageelements/CreateOrderGiftCard"

export default class CreateOrderActions
{
    constructor(){

        globalThis.order = new CreateOrderGiftCard();
...
AddProductstoCart(productIds, quantity)
{
    ...
    GiftCardCheckout(productIds, priorityshipping,giftcardmode, giftcardnumber, giftcardpin)
    {
        /*  for(let i =0 ;i<productIds.length ;i ++)
        {
