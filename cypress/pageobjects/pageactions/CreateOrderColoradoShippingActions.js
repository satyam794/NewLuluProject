...
import CreateOrderColoradoShipping from "../../pageobjects/pageelements/CreateOrderColoradoShipping"

export default class CreateOrderColoradoShippingActions
{
    constructor(){

        globalThis.order = new CreateOrderColoradoShipping();
    }
    ...
    AddShippingAddress(addresstype, fname, lname, phone, emailid, address1, address2, city, zipcode, country, state)
    {
                ...
                order.SelectMatchedAddress().click()
